...
public class KozossegiNewsFeed extends JPanel {
	...
	public KozossegiNewsFeed(KozossegiMainFrame mainFrame) {
		...
		add(new KozossegiPost(new KozossegiPostData(1, new KozossegiProfileNameBean(670, "Asd"), new KozossegiProfileNameBean(1020, "asd"), new Date(), "megbassza a mocskos kurvaisten http://icons.iconarchive.com/icons/graphicloads/100-flat/256/home-icon.png", 0)),BorderLayout.CENTER);
		add(new KozossegiPost(new KozossegiPostData(1, new KozossegiProfileNameBean(670, "Asd"), new KozossegiProfileNameBean(1020, "asd"), new Date(), "http://icons.iconarchive.com/icons/graphicloads/100-flat/256/home-icon.png", 0)),BorderLayout.CENTER);
	}
