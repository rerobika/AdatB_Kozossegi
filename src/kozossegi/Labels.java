...
public class Labels {
	...
	public static final String CREATE_PROFILE = "START TRANSACTION;INSERT INTO FELHASZNALO (NEV) VALUES(?);"
			+ "INSERT INTO SZEMELY(ID,JELSZO,EMAIL) "
			+ "VALUES( FELHASZNALO_SEQ.CURRVAL,?,?);"
			+ "INSERT INTO PROFIL(SZEMELYID,SZUL_DATUM,NEM,LAKHELYID,ISKOLAID,HOBBID,MUNKAHELYID,MEGHIVO,PROFILKEP) "
			+ "VALUES(FELHASZNALO_SEQ.CURRVAL,?,?,?,?,?,?,?,?); COMMIT;";
	public static final String ADD_SCHOOL = "INSERT INTO ISKOLA(NEV) VALUES(?)";
	public static final String ADD_WORKPLACE = "INSERT INTO MUNKAHELY(NEV) VALUES(?)";
	public static final String ADD_RESIDENCE = "INSERT INTO LAKHELY(NEV) VALUES(?)";
	public static final String ADD_HOBBY = "INSERT INTO HOBBI(NEV) VALUES(?)";
