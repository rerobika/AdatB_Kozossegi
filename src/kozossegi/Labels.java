...
public class Labels {
	...
	public static final String SEARCH = "SELECT SZEMELY.ID FROM FELHASZNALO, SZEMELY WHERE FELHASZNALO.ID = SZEMELY.ID AND SZEMELY.ID <> ? AND INSTR(LOWER(FELHASZNALO.NEV), ?) > 0";
	...
	public static final String SEARCH_RESULT = "Találatok:";
